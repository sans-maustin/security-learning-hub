...
f. Enter httpd at the passphrase prompt.
...
**Now to sign it ourselves (if you were going to create a commercial key, you would send the CSR file in to get signed):**
